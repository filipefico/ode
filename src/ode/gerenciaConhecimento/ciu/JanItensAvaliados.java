		...
		botaoAvaliar.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event arg0) throws Exception {
				...
				if(listboxBuscarItensConhecimento.getSelectedIndex() == -1){
					...
					ctrlGerenciaConhecimento.guardarSessao(JanItensAvaliados.class.getName(), itens, null);
					...
					if(objeto != null){
						ctrlGerenciaConhecimento.exibirJanelaAvaliarItemConhecimento((ItemConhecimento) objeto);
					}
				}
			}
		});
