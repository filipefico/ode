...
@Component
public class FormDadosKObjetivoSoftware extends
		FormularioDadosCRUD<KObjetivoSoftware> {
	...
	protected List<NucleoTab> definirTabs() {
		...
		CtrlKObjetivoSoftwareCRUD ctrl = (CtrlKObjetivoSoftwareCRUD) this
				.getControlador();
		AplCadastrarKObjetivoEstrategico apl = ctrl
	...
	@Override
	protected void preencherDadosTela(KObjetivoSoftware objeto)
