...
public class DadosBanco {
	...
	private void inicializarKCategoriasProcesso() throws NucleoRegraNegocioExcecao {
	...
	private void inicializarDefinicaoProcesso() throws NucleoRegraNegocioExcecao {
		//inserir processos
	...
	private void inicializarFerramentasSoftware() throws NucleoRegraNegocioExcecao {
		AplCadastrarFerramentaSoftware aplFS = (AplCadastrarFerramentaSoftware) SpringUtil.getBean(AplCadastrarFerramentaSoftware.class.getSimpleName());
		AplCadastrarKFerramentaSoftware aplKFS = (AplCadastrarKFerramentaSoftware) SpringUtil.getBean(AplCadastrarKFerramentaSoftware.class.getSimpleName());
	...
	private KRecursoHumano inserirKRecursoHumano(String nome) throws NucleoRegraNegocioExcecao {
	...
	private KCategoriaProcesso inserirKCategoriaProcesso(String nome, String Descricao) throws NucleoRegraNegocioExcecao {
	...
	private KTipoInteracao inserirKTipoInteracao(String nome,
