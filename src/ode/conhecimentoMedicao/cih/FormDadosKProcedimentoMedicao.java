...
@Component
public class FormDadosKProcedimentoMedicao extends
		FormularioDadosCRUD<KProcedimentoMedicao> {
	...
	@Override
	protected void preencherDadosTela(KProcedimentoMedicao objeto) throws NucleoRegraNegocioExcecao {
		tbNome.setText(objeto.getNome());
		tbDescricao.setText(objeto.getDescricao());
	}

	@Override
	protected void preencherDadosObjeto(KProcedimentoMedicao objeto) {
