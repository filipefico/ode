...
public class FormDadosKObjetivoEstrategico extends FormularioDadosCRUD<KObjetivoEstrategico>{
	...
	@Override
	protected void preencherDadosTela(KObjetivoEstrategico objeto) throws NucleoRegraNegocioExcecao {
		tbNome.setText(objeto.getNome());
		tbDescricao.setText(objeto.getDescricao());
	}

	@Override
	protected void preencherDadosObjeto(KObjetivoEstrategico objeto) {
