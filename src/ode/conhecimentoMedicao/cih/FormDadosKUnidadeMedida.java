...
@Component
public class FormDadosKUnidadeMedida extends
		FormularioDadosCRUD<KUnidadeMedida> {
	...
	@Override
	protected void preencherDadosTela(KUnidadeMedida objeto) throws NucleoRegraNegocioExcecao {
		tbNome.setText(objeto.getNome());
		tbDescricao.setText(objeto.getDescricao());
	}

	@Override
	protected void preencherDadosObjeto(KUnidadeMedida objeto) {
