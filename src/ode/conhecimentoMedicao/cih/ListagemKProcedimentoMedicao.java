...
public class ListagemKProcedimentoMedicao extends ListagemSimples<KProcedimentoMedicao> {
	...
	@Override
	protected String[] recuperarDadosObjeto(KProcedimentoMedicao objeto) {
