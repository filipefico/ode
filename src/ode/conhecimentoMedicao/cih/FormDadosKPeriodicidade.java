...
@Component
public class FormDadosKPeriodicidade extends
		FormularioDadosCRUD<KPeriodicidade> {
	...
	@Override
	protected void preencherDadosTela(KPeriodicidade objeto) throws NucleoRegraNegocioExcecao {
		tbNome.setText(objeto.getNome());
		tbDescricao.setText(objeto.getDescricao());
	}

	@Override
	protected void preencherDadosObjeto(KPeriodicidade objeto) {
