...
@Component
public class FormDadosKMetodoAnalitico extends
		FormularioDadosCRUD<KMetodoAnalitico> {
	...
	@Override
	protected void preencherDadosTela(KMetodoAnalitico objeto) throws NucleoRegraNegocioExcecao {
		tbNome.setText(objeto.getNome());
		tbDescricao.setText(objeto.getDescricao());
	}

	@Override
	protected void preencherDadosObjeto(KMetodoAnalitico objeto) {
