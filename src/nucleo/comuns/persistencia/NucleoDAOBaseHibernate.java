...
public abstract class NucleoDAOBaseHibernate<T extends NucleoObjetoPersistenteImpl>
	...
	/**
	 * M�todo abstrato a ser implementado pelas subclasses para que retornem a
	 * classe de dom�nio que � persistida por elas.
	 * 
	 * @return Classe de dom�nio que � persistida pelas subclasses.
	 */
	...
	public Collection<T> recuperarTodos() {
		...
		// O encapsulamento final dentro do ArrayList visa � melhoria de
